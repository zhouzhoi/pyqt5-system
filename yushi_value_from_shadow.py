...
def getDeviceShadow():
    ...
    endpoint = "https://9bcb25f028.st1.iotda-app.cn-north-4.myhuaweicloud.com:443/v5/iot/1dc58e416b8f4702b3345b1343af3bb3/devices/648c57b7ec46a256bca6829f_yushi/shadow"
    ...
    print("智能浴室的原始属性解析要求如下：")
    print("wendu:" + str(result["wendu"]))
    print("shidu:" + str(result["shidu"]))
    print("guangzhao:" + str(result["guangzhao"]))
    print("shuiwen:" + str(result["shuiwen"]))
    print("shengyin:" + str(result["shengyin"]))
    return response
